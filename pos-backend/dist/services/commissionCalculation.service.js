...
exports.CommissionCalculationService = {
     ...
     */
    async calculateCommission(saleTotal) {
        const activeConfig = await commission_repository_1.CommissionRepository.findActive();
     ...
     */
    calculateLegacyCommission(saleTotal) {
        if (saleTotal <= 100)
            return 5;
        if (saleTotal <= 400)
            return 10;
