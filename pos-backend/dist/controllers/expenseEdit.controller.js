...
exports.ExpenseEditController = void 0;
const expenseEdit_service_1 = require("../services/expenseEdit.service");
exports.ExpenseEditController = {
    async update(req, res) {
        try {
            ...
            const updatedExpense = await expenseEdit_service_1.ExpenseEditService.updateExpense(expenseId, dto, String(userId), targetBranchId);
            return res.json({
                success: true,
